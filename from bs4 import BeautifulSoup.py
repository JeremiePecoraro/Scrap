    ...
    for page in range(1, 11):
        ...
        for result in searchCard_elements:
            ...
            fuel = result.find_all(
                class_="Text_Text_text Vehiculecard_Vehiculecard_characteristicsItems Text_Text_body2")[2].text
            mileage = result.find_all(
                class_="Text_Text_text Vehiculecard_Vehiculecard_characteristicsItems Text_Text_body2")[1].text

            if result:
                print("Marque :", brand, "Modèle  :", model, "Année :", year, '\n',
                      "Prix :", price, '\n', "Moteur :", motor, '\n' "Fuel :", fuel, '\n', "Mileage :", mileage)

                data.append([brand, model, year, price, motor, fuel, mileage])
